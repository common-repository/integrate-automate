...
<div class="wrap">
    <h1>
        ...
        <?php esc_attr_e( 'Edit Intermigration.', 'integrate_automate' ); ?>
    </h1>

    <div id="edit_connection">
        <div id="post-body" class="metabox-holder">
            <div id="vuejs-app-div" >
                ...
                <form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post" >
                    ...
                    <input type="hidden" name="integrationID" value="<?php echo $integrationID; ?>" />
                        ...
                        <table class="widefat">
                            <tbody>
                                <tr class="alternate">
                                    ...
                                    <td> <input type="text" name="integrationTitle" value="<?php echo $integrationTitle; ?>" id='integrationTitle' class="large-text" placeholder="<?php _e( 'Enter intermigration title here', 'integrate_automate'); ?>" required="required"> </td>
                                </tr>

                                <tr>
                                    <td class="row-title"> <label for="tablecell"> <?php esc_attr_e('Event source', 'integrate_automate'); ?> </label> </td>
                                    <td>
                                        <select name="eventSource" id="eventSource" style="width:79%;" >
                                ...
                                <tr class="alternate">
                                    <td class="row-title"> <label for="tablecell"> <?php esc_attr_e('Custom data for request Head', 'integrate_automate'); ?> </label> </td>
                                    <td>
                                        <input type="text" class="large-text"  name="customFieldsInHead" value="<?php echo  htmlspecialchars($customFieldsInHead) ; ?>"  placeholder="<?php _e( 'Please insert valid JSON  e.g. { &#8220;Accept-Charset&#8221; : &#8220;utf-8&#8221;, &#8220;If-Match&#8221; : &#8220;737060cd8c284d8a&#8221; } ', 'integrate_automate'); ?>"> 
                                    </td>
                                </tr>
                                ...
                                <tr >
                                    ...
                                    <td>       
                                        <input type="text" class="large-text"  name="customFieldsInBody" value="<?php echo htmlspecialchars( $customFieldsInBody) ; ?>"  placeholder="<?php _e( 'Please insert valid JSON  e.g. { &#8220;ID&#8221; : &#8220;182943&#8221;, &#8220;location&#8221; : &#8220;TX&#8221; } ', 'integrate_automate'); ?>"> 
                                    </td>
                                </tr>
                                ...
                                <tr class="alternate">
                                    ...
                                    <td id="webHookUrl">
                                       <input type="url" class="large-text"  name="webHookUrl" value="<?php echo $webHookUrl; ?>" id='webHookUrl' placeholder="<?php _e( 'Intermigration Webhook URL', 'integrate_automate'); ?>" required="required"> 
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <p>
                        <input class="button-primary" type="submit" name="saveRelation" value="<?php esc_attr_e( 'Save edited intermigration', 'integrate_automate' ); ?>" />
